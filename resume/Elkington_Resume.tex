...
\begin{rSection}{Experience}
    ...
    \vspace{-6pt}
    \begin{itemize}[nosep]
        \item Develop fast \& scalable {\bf Databricks/PySpark} economic data categorization pipelines
%        \item Design distributed profiling frameworks to assess causes of inefficiencies \& propose solutions
