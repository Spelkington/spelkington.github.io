...
\begin{rSection}{Experience}
    ...
    \href{https://mscience.com/}{\bf Data Analyst | Data Science \& Engineering Team}, {\em M Science \hfill June 2021 - Present}
    \vspace{-6pt}
    \begin{itemize}[nosep]
        \item Developed and tested {\bf Databricks/PySpark} data categorization pipelines and processes
        \item Implemented production data pipelines to streamline categorization work and reduce compute costs
        \item Designed {\bf Tableau} dashboards for pipeline performance profiling \& cost optimization insights
    \end{itemize}
...
\begin{rSection}{Projects}
    ...
    \begin{itemize}[nosep]
        ...
        \item Created and moderated a virtual campus for 500+ students to test application prior to opening source 
