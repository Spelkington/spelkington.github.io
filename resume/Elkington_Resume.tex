...
%    \\Emph. Business Economics \& Analytics
...
%    \href{https://github.com/Spelkington/mlearning}{Data Science}, % SPLEARN
    \href{https://github.com/UtahTriangle/Laws/blob/main/Proposals/NationalsHelp/figures/distances.pdf}{Data Science}, % TRIANGLE MAP
    \href{https://github.com/Spelkington/mlearning}{Machine Learning}, %SPLEARN
    \href{https://spelkington.github.io/assets/utah_office_update.pdf}{Strategic Consulting}, % UTAH OFFICE UPDATE
%    \href{https://www.roblox.com/games/272941/Robloxaville}{Game Development}, % ROBLOXAVILLE
    Algorithms,
%    Data Structures,
%    Software Dev,
...
\begin{rSection}{Experience}
    ...
    \vspace{-6pt}
    \begin{itemize}[nosep]
        \item Developed and tested {\bf Databricks/PySpark} data categorization pipelines and processes
        \item Designed {\bf Tableau} dashboards for pipeline performance analytics \& business cost insights
        \item Researched \& implemented {\bf AWS/Spark} optimizations to reduce job run costs by as much as 90\%
    \end{itemize}
...
%         \item Designed visualizations and dashboards in {\bf Tableau} to tell intuitive stories with data
    ...
    \href{https://slateci.io/}{\bf DevOps Research Intern}, {\em Utah Center for High-Performance Computing \hfill Mar 2019 - Feb 2020}
    \vspace{-6pt}
    \begin{itemize}[nosep]
        \item Built a {\bf Kubernetes/Docker} platform to simplify deployment of science apps on cloud edge systems
%        \item Constructed project documentation site in {\bf React.js} to polish appearance for NSF grant proposals
...
%    \href{https://spelkington.github.io}{\bf CoinPal: Trust Your Friends With Your Savings!} \hfill {\em 2021}
%    \vspace{-6pt}
%    \begin{itemize}[nosep]
...
%    \href{https://spelkington.github.io/Job-Search-Hell/}{\bf Live Resume CI Pipeline} \hfill {\em 2020 - 2021}
%    \vspace{-6pt}
%    \begin{itemize}[nosep]
%        \item Implemented a continuous integration pipeline to host dynamic copies of resumes via {\bf GitHub Pages}
...
%    \end{itemize}
    ...
    \href{https://www.roblox.com/games/272941/Robloxaville}{\bf Robloxaville} \hfill {\em 2017 - 2018}
    \vspace{-6pt}
    \begin{itemize}[nosep]
...
\begin{rSection}{Organizations}
    ...
    \begin{itemize}[nosep]
        ...
        \item Redesigned governing organization to provide a better environment for chapter growth \& self-governance
...
%%    \end{itemize}
    ...
    \href{http://content.csbs.utah.edu/~rogers/ant5221/lab/manual.pdf}{\bf Genomomic Data Science Tutoring}, {\em University of Utah \hfill 2017}
    \vspace{-6pt}
    \begin{itemize}[nosep]
