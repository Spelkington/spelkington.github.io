...
%    \href{https://github.com/Spelkington/mlearning}{Machine Learning}, %SPLEARN
    \href{https://github.com/UtahTriangle/PointyPal}{Software Development}
%    \href{https://spelkington.github.io/assets/utah_office_update.pdf}{Strategic Consulting}, % UTAH OFFICE UPDATE
    \href{https://spelkington.github.io/assets/utah_office_update.pdf}{Visualization Technology}, % UTAH OFFICE UPDATE
...
\begin{rSection}{Experience}
    ...
    \vspace{-6pt}
    \begin{itemize}[nosep]
        \item Develop fast \& scalable {\bf Databricks/PySpark} data categorization pipelines and processes
        \item Design distributed profiling frameworks to diagnose causes of inefficiencies \& propose solutions
%        \item Designed {\bf Tableau} dashboards for pipeline performance analytics \& business cost insights
        \item Investigate \& implement {\bf AWS/Spark} optimizations to boost task efficiencies by as much as 90\%
    \end{itemize}
