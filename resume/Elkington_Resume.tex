...
\begin{rSection}{Experience}
    ...
    \href{https://mscience.com/}{\bf Data Analyst}, {\em M Science \hfill June 2021 - Present}
    \vspace{-6pt}
    \begin{itemize}[nosep]
        \item Developed and tested {\bf Databricks} prototypes for data categorization pipelines and processes
        \item Implemented production data pipelines to streamline categorization work and reduce compute costs
        \item Designed {\bf Tableau} dashboard insights for workflows, data processes, and compute \& storage costs
    \end{itemize}
