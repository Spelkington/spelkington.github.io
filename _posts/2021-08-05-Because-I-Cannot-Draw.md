---
layout: post
title: A Rant About Game Development, and an Homage to a Cool Mom
---

Guilty confession: I've had a ROBLOX account for 14 years. At 23 years old, that's *half my life.* Yeesh.
...
And then the server would, once again, gleefully remove the head of some unlucky soul, *even though it wasn't told to in the game's code.*
...
Even though this feature [could be disabled](https://developer.roblox.com/en-us/articles/Converting-From-Experimental-Mode) to allow legacy games to keep functioning, ROBLOX's featured games algorithm wouldn't touch your project with a ten-foot pole for risk of traumatizing even more unsuspecting children. This was especially important for the next major change,
