...
\address{
  ...
  %
  \href{mailto:business+inquiry@chaoticgood.computer?subject=Regarding\%20a\%20potential\%20business\%20opportunity&body=Hi,\%20Spencer!}
     {Email} \\ 
...
\begin{rSection}{Experience}
  ...
  \vspace{-6pt}
  \begin{itemize}[nosep]
    \item Create \textbf{Terraform} deployment systems, reducing first-time environment spin-up time by >90\%
    \item Port legacy microservices to \textbf{C\#} to boost efficiency and capacity of Congressional schedule services
    \item Oversee creation of internal documentation-as-code system adopted by all engineering teams
  \end{itemize}
  ...
  \begin{itemize}[nosep]
    ...
    \item Manage \& coordinate financial investments into talent and asset acquisitions
  \end{itemize}
