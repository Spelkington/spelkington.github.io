...
\address{
  ...
  %
  \href{mailto:business+inquiry@chaoticgood.computer?subject=Regarding\%20a\%20potential\%20work\%20opportunity&body=Hi,\%20Spencer!}
     {Email} \\ 
  \href{https://blog.chaoticgood.computer}{Website} \\
...
\vspace{2pt}
  \\ Bachelor of Science | \href{https://chaoticgood.computer/?search=Economics}{Quantitative Analysis of Markets \& Organizations}
  \\ Minor | \href{https://chaoticgood.computer/?search=Software}{Computer Science}
...
\begin{adjustwidth}{6em}{0pt}
  ...
  \href{https://chaoticgood.computer/?search=Games}{Game Dev} |
  \href{https://chaoticgood.computer/?search=DevOps}{DevOps} |
  \href{https://chaoticgood.computer/?search=Visualization}{Visualizations} |
...
\begin{adjustwidth}{6em}{0pt}
  ...
  \href{https://backstage.spotify.com/}{Backstage} |
  \href{https://chaoticgood.computer/?search=Spark}{Apache Spark} | 
  \href{https://chaoticgood.computer/?search=Databricks}{Databricks}
  % EC2 | 
  % Snowflake | 
  % Tableau
...
\begin{adjustwidth}{6em}{0pt}
  ...
  \href{https://chaoticgood.computer/?search=Lua}{Lua} | 
  \href{https://chaoticgood.computer/?search=C++}{C++} |
...
\begin{rSection}{Experience}
  ...
  \href{https://nwyc.com/frontpage}{{\bf Software Engineer | Backend \& DevOps} | {\em National Write Your Congressman}} \hfill {\em Feb 2023 - Present}
  \vspace{-6pt}
  \begin{itemize}[nosep]
    \item Created \textbf{Terraform} deployment systems, reducing first-time environment spin-up time by >90\%
    \item Ported legacy microservices to \textbf{C\#} to boost efficiency and capacity of Congressional schedule services
    \item Oversaw creation of internal documentation-as-code system adopted by all engineering teams
  \end{itemize}

  \href{https://blog.chaoticgood.computer}{{\bf Founder \& Lead Engineer} | {\em Chaotic Good Computing}} \hfill {\em May 2023 - Present}
  \vspace{-6pt}
  \begin{itemize}[nosep]
    \item Founded a business for development of games focused on gameplay loops driven by continuous analytics
    ...
    \item Managed \& coordinated financial investments into talent and asset acquisitions
  \end{itemize}
...
%     \item Created \& maintained {\bf Tableau} dashboards for pipeline performance analytics \& business cost insights
...
%  {\bf Medical Device Assembler}, {\em Bard Access Systems \hfill June 2016 - Aug 2016}
%  \vspace{-6pt}
%  \begin{itemize}[nosep]
...
%  \href{https://chaoticgood.computer/Job-Search-Hell/}{\bf Live Resume Continuous Integration Pipeline} \hfill {\em 2021}
%  \vspace{-6pt}
%  \begin{itemize}[nosep]
...
%   \href{https://chaoticgood.computer/?search=Roblox}{{\bf Independent Game Development} | {\em ROBLOX}} \hfill {\em May 2018 - June 2022}
%   \vspace{-6pt}
%   \begin{itemize}[nosep]
...
%  \href{https://chaoticgood.computer}{\bf CoinPal: Trust Your Friends With Your Savings!} \hfill {\em 2020}
%  \vspace{-6pt}
%  \begin{itemize}[nosep]
...
%%  {\em \href{https://chaoticgood.computer/Elkington_Full_Resume.pdf}{Full Resumé}}
%\end{center}
